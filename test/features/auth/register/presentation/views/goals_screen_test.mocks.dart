...
// in fitness_app/test/features/auth/register/presentation/views/goals_screen_test.dart.
...
class MockRegisterCubit extends _i1.Mock implements _i3.RegisterCubit {
  ...
  @override
  int get weiht =>
      (super.noSuchMethod(Invocation.getter(#weiht), returnValue: 0) as int);

  @override
  set weiht(int? _weiht) => super.noSuchMethod(
    Invocation.setter(#weiht, _weiht),
    returnValueForMissingStub: null,
  );
