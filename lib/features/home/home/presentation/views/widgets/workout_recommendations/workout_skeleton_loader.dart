...
/// Skeleton loader for workout recommendations section
class WorkoutSkeletonLoader extends StatelessWidget {
  final int itemCount;

  const WorkoutSkeletonLoader({super.key, this.itemCount = 3});
