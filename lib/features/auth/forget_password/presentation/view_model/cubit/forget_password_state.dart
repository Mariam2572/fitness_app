...
final class ForgetPasswordError extends ForgetPasswordState {
  ...
  const ForgetPasswordError({required this.errorMessage,required this.failureMessage});
  @override
...
final class VerifyResetError extends ForgetPasswordState {
  ...
  const VerifyResetError({required this.errorMessage,required this.failureMessage});
  @override
  List<Object> get props => [errorMessage, failureMessage];
}
...
final class ResetPasswordError extends ForgetPasswordState {
  ...
  const ResetPasswordError({required this.errorMessage,required this.failureMessage});
  @override
  List<Object> get props => [errorMessage, failureMessage];
}
