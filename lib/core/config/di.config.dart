...
import '../../features/profile/edit_profile/domain/use_cases/upload_photo_use_case.dart'
    as _i978;
import '../../features/smartCoach/data/data_source/local/chat_history_service.dart'
    as _i527;
import '../../features/smartCoach/data/data_source/remote_data_source/smart_coach_remote_data_source_impl.dart'
    as _i101;
import '../../features/smartCoach/data/repo/chat_history_repo.dart' as _i722;
import '../../features/smartCoach/data/repo/smart_coach_repo_impl.dart' as _i94;
import '../../features/smartCoach/domain/repos/smart_coach_remote_data_source.dart'
    as _i1032;
import '../../features/smartCoach/domain/repos/smart_coach_repo.dart' as _i521;
import '../../features/smartCoach/domain/use_case/send_message_use_case.dart'
    as _i469;
import '../../features/smartCoach/presentation/cubit/smart_coach_cubit.dart'
    as _i46;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.factory<_i1032.SmartCoachRemoteDataSource>(() =>
        _i101.SmartCoachRemoteDataSourceImpl(
            geminiService: gh<_i92.GeminiService>()));
    gh.factory<_i521.SmartCoachRepo>(() => _i94.SmartCoachRepoImpl(
        remoteDataSource: gh<_i1032.SmartCoachRemoteDataSource>()));
    gh.factory<_i469.SendMessageUseCase>(
        () => _i469.SendMessageUseCase(gh<_i521.SmartCoachRepo>()));
    ...
    gh.factory<_i46.SmartCoachCubit>(() => _i46.SmartCoachCubit(
          gh<_i469.SendMessageUseCase>(),
          gh<_i722.ChatHistoryService>(),
