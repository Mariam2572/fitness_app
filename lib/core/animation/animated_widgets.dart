import 'package:fitness_app/core/animation/fade_transition_animation.dart';
import 'package:fitness_app/core/animation/scale_transition_animation.dart';
import 'package:fitness_app/core/animation/slide_transition_animation.dart';
...
class AnimatedSlideInWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SlideTransitionAnimation(
      ...
      curve: curve,
      child: FadeTransitionAnimation(duration: duration, child: child),
    );
  }
}
...
class AnimatedFadeInWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return FadeTransitionAnimation(duration: duration, child: child);
  }
}
