...
class _ApiService implements ApiService {
  ...
  @override
  Future<UserResponse> getUserData(String userToken) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  @override
  Future<GetUserDataReponse> getLoggedProfileData() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetUserDataReponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetUserDataReponse _value;
    try {
      _value = GetUserDataReponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<VerifyResetResponse> verifyResetCode(
      VerifyResetRequest verifyResetRequest) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(verifyResetRequest.toJson());
    final _options = _setStreamType<VerifyResetResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
